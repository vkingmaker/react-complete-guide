...
// import { OrderDataType } from '../../../shared/types';
// import { Dispatch } from 'redux';

interface ContactDataProps {
  ings: 'salad' | 'cheese' | 'meat' | 'bacon';
  token: string;
  userId: string;
  price: any;
...
const mapStateToProps = (state: {
  burgerBuilder: {
    ingredients: 'salad' | 'cheese' | 'meat' | 'bacon';
    totalPrice: number;
  };
...
//   return {
//     onOrderBurger: (orderData: OrderDataType, token: string) =>
